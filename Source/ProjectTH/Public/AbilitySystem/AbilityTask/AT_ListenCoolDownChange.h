...
#include "AT_ListenCoolDownChange.generated.h"
...
class PROJECTTH_API UAT_ListenCoolDownChange : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UAT_ListenCoolDownChange* ListenCooldownChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer InCooldownTags, bool InUseServerCooldown);
